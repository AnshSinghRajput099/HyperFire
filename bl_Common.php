...
const DATA_BASE_NAME = 'id22325437_hyperfire';
const DATA_BASE_USER = 'id22325437_hyperfire';
const DATA_BASE_PASSWORLD = 'Anshsingh1234@';
...
const ADMIN_EMAIL = 'anshwithlaptop@gmail.com'; // email address from which the verification emails will be send.
const GAME_NAME = 'Hyper Fire';
